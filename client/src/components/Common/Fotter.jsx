    ...
    <footer className="border-t py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8  px-4  lg:px-0">
        <div className=" mx-8">
          ...
          <p className="font-medium text-sm mb-2 text-gray-600">Sign up and get 10% off your first order.</p>
          ...
          <form  className="flex">
            ...
            focus:outline-none focus:ring-gray-500 transition-all " required/>
        ...
        {/* Shop Links */}
        <div>
            <h3 className="text-lg text-gray-800 md-4">Shop</h3>
        ...
        {/* Support Links */}
         ...
         <div>
            <h3 className="text-lg text-gray-800 md-4">Support</h3>
            <ul className="space-y-2 text-gray-600">
                <li>
      ...
      <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
        <p className="text-gray-500 text-sm tracking-tighter text-center">© 2025, CompilerTab. All Rights Reserved.</p>
      </div>
    </footer>
  );
};
