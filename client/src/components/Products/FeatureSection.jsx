    ...
    <section className='py-16 px-4 bg-white'>
        <div className=' container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <h4 className='teacking-tighter mb-2'>Free INTERNATIONAL SHIPPING</h4>
            ...
            <div className='flex flex-col items-center'>
                ...
                <h4 className='teacking-tighter mb-2'>45 DAYS RETURN</h4>
            ...
            <div className='flex flex-col items-center'>
                ...
                <h4 className='teacking-tighter mb-2'>SECURE CHECKOUT</h4>
